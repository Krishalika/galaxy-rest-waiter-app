...
export default function ReservationsForm1({ open, setOpen, navigation }) {
  ...
  const submitReservation1 = () => {
    ...
    axios
      .post(`https://galaxy-rest-be.herokuapp.com/tableres/add/`, data)
      .then(({ data }) => {
        setOpen(false);
        Toast.show({
          topOffset: 40,
          ...
          position: "top",
          type: "success",
          text1: "Reservation is placed successfully",
        });
      })
      .catch((e) => {
        Toast.show({
          ...
          position: "top",
          type: "error",
          text1: "Reservation is not placed",
        });
      });
  };
  ...
  return (
    <View style={globalStyles.container}>
      ...
      <TouchableOpacity onPress={showEndTimePicker}>
        <View style={styles.commonCard}>
          <Text style={styles.buttonText}>Select Reservation Ending Time</Text>
        </View>
      </TouchableOpacity>
      <DateTimePickerModal
      ...
      <PrimaryButton
        ...
        title={"SAVE"}
        onPress={(findTableID(tableNo), submitReservation1)}
        marginTop="50"
      />
    </View>
  );
